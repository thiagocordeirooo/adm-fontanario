...
!function(){"use strict";angular.module("app",["ngRoute","ngCookies","angular-loading-bar","angularUtils.directives.dirPagination"])}(),function(){"use strict";function a(a,b,c,d){function e(b){switch(b){case"paper":a.themeColor="#2196F3";break;case"sandstone":a.themeColor="#93C54B";break;case"superhero":a.themeColor="#DF691A";break;case"yeti":a.themeColor="#008CBA"}}a.theme="paper",a.$on("$routeChangeStart",function(f,g,h){if("/login"!=b.path()){var i=c.get("_c");null==i?(a.isAuthenticated=!1,a.theme="paper",a.themeColor="#93C54B",d.defaults.headers.common={Accept:"application/json, text/plain, */*"}):(i=angular.fromJson(i),d.defaults.headers.common.Authorization="Bearer "+i.token,a.theme=i.currentuser.Theme,e(a.theme),a.currentUser=i.currentuser,a.isAuthenticated=!0),g.authorize&&!a.isAuthenticated&&b.path("/login")}})}angular.module("app").run(a),a.$inject=["$rootScope","$location","$cookies","$http"],toastr.options={closeButton:!1,debug:!1,newestOnTop:!1,progressBar:!0,positionClass:"toast-top-right",preventDuplicates:!1,onclick:null,showDuration:"300",hideDuration:"1000",timeOut:"5000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"}}(),function(){"use strict";angular.module("app").constant("CONSTANTS",{baseURL:"https://api-admfontanario.azurewebsites.net/api/"})}(),function(){"use strict";function a(a,b){b.interceptors.push("sessionRecoverer"),a.when("/",{controller:"HomeController",controllerAs:"vm",templateUrl:"app/views/home/index.html",authorize:!0}).when("/login",{controller:"AuthenticationController",controllerAs:"vm",templateUrl:"app/views/home/authentication.html"}).when("/index",{controller:"HomeController",controllerAs:"vm",templateUrl:"app/views/home/index.html",authorize:!0}).when("/consumidores",{controller:"ConsumidorListController",controllerAs:"vm",templateUrl:"app/views/consumidor/consumidor-list.html",authorize:!0}).when("/consumidores/edit/:id",{controller:"ConsumidorEditController",controllerAs:"vm",templateUrl:"app/views/consumidor/consumidor-edit.html",authorize:!0}).when("/adm/usuarios",{controller:"UsuarioListController",controllerAs:"vm",templateUrl:"app/views/usuario/usuario-list.html",authorize:!0}).when("/adm/usuarios/edit/:id",{controller:"UsuarioEditController",controllerAs:"vm",templateUrl:"app/views/usuario/usuario-edit.html",authorize:!0}).when("/meu-usuario",{controller:"UsuarioEditController",controllerAs:"vm",templateUrl:"app/views/usuario/usuario-edit.html",authorize:!0,param:"myUser"}).when("/adm/log-integracao",{controller:"LogIntegracaoListController",controllerAs:"vm",templateUrl:"app/views/log-integracao/log-integracao-list.html",authorize:!0}).otherwise({controller:"HomeController",controllerAs:"vm",templateUrl:"app/views/home/404.html"})}angular.module("app").factory("sessionRecoverer",["$location","$q","$injector",function(a,b,c){var d={responseError:function(c){return 401==c.status&&(a.path("/login"),toastr.info("Sua sessão expirou, faça o login novamente.")),b.reject(c)}};return d}]),angular.module("app").config(a),a.$inject=["$routeProvider","$httpProvider"]}(),function(){function a(a,b,c){function d(d,k){var l=k.dirPaginate,m=l.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),n=/\|\s*itemsPerPage\s*:[^|]*/;if(null===m[2].match(n))throw"pagination directive: the 'itemsPerPage' filter must be set.";var o=m[2].replace(n,""),p=b(o);g(d);var q=k.paginationId||j;return c.registerInstance(q),function(d,g,k){var m=b(k.paginationId)(d)||k.paginationId||j;c.registerInstance(m);var n=e(l,m);f(g,k,n),h(g);var o=a(g),q=i(d,k,m);c.setCurrentPageParser(m,q,d),"undefined"!=typeof k.totalItems?(c.setAsyncModeTrue(m),d.$watch(function(){return b(k.totalItems)(d)},function(a){0<=a&&c.setCollectionLength(m,a)})):d.$watchCollection(function(){return p(d)},function(a){a&&c.setCollectionLength(m,a.length)}),o(d)}}function e(a,b){var c,d=!!a.match(/(\|\s*itemsPerPage\s*:[^|]*:[^|]*)/);return c=b===j||d?a:a.replace(/(\|\s*itemsPerPage\s*:[^|]*)/,"$1 : '"+b+"'")}function f(a,b,c){a[0].hasAttribute("dir-paginate-start")||a[0].hasAttribute("data-dir-paginate-start")?(b.$set("ngRepeatStart",c),a.eq(a.length-1).attr("ng-repeat-end",!0)):b.$set("ngRepeat",c)}function g(a){angular.forEach(a,function(a){a.nodeType===Node.ELEMENT_NODE&&angular.element(a).attr("dir-paginate-no-compile",!0)})}function h(a){angular.forEach(a,function(a){a.nodeType===Node.ELEMENT_NODE&&angular.element(a).removeAttr("dir-paginate-no-compile")}),a.eq(0).removeAttr("dir-paginate-start").removeAttr("dir-paginate").removeAttr("data-dir-paginate-start").removeAttr("data-dir-paginate"),a.eq(a.length-1).removeAttr("dir-paginate-end").removeAttr("data-dir-paginate-end")}function i(a,c,d){var e;if(c.currentPage)e=b(c.currentPage);else{var f=d+"__currentPage";a[f]=1,e=b(f)}return e}return{terminal:!0,multiElement:!0,compile:d}}function b(){return{priority:5e3,terminal:!0}}function c(a){a.put("angularUtils.directives.dirPagination.template",'<ul class="pagination" ng-if="1 < pages.length"><li ng-if="boundaryLinks" ng-class="{ disabled : pagination.current == 1 }"><a href="" ng-click="setCurrent(1)">&laquo;</a></li><li ng-if="directionLinks" ng-class="{ disabled : pagination.current == 1 }"><a href="" ng-click="setCurrent(pagination.current - 1)">&lsaquo;</a></li><li ng-repeat="pageNumber in pages track by $index" ng-class="{ active : pagination.current == pageNumber, disabled : pageNumber == \'...\' }"><a href="" ng-click="setCurrent(pageNumber)">{{ pageNumber }}</a></li><li ng-if="directionLinks" ng-class="{ disabled : pagination.current == pagination.last }"><a href="" ng-click="setCurrent(pagination.current + 1)">&rsaquo;</a></li><li ng-if="boundaryLinks"  ng-class="{ disabled : pagination.current == pagination.last }"><a href="" ng-click="setCurrent(pagination.last)">&raquo;</a></li></ul>')}function d(a,b){function c(b,c,e){function g(c){k(c)&&(b.pages=d(c,a.getCollectionLength(m),a.getItemsPerPage(m),o),b.pagination.current=c,i(),b.onPageChange&&b.onPageChange({newPageNumber:c}))}function h(){var c=parseInt(a.getCurrentPage(m))||1;b.pages=d(c,a.getCollectionLength(m),a.getItemsPerPage(m),o),b.pagination.current=c,b.pagination.last=b.pages[b.pages.length-1],b.pagination.last<b.pagination.current?b.setCurrent(b.pagination.last):i()}function i(){var c=a.getCurrentPage(m),d=a.getItemsPerPage(m),e=a.getCollectionLength(m);b.range.lower=(c-1)*d+1,b.range.upper=Math.min(c*d,e),b.range.total=e}function k(a){return f.test(a)&&0<a&&a<=b.pagination.last}var l=e.paginationId||j,m=b.paginationId||e.paginationId||j;if(!a.isRegistered(m)&&!a.isRegistered(l)){var n=m!==j?" (id: "+m+") ":" ";throw"pagination directive: the pagination controls"+n+"cannot be used without the corresponding pagination directive."}b.maxSize||(b.maxSize=9),b.directionLinks=!angular.isDefined(e.directionLinks)||b.$parent.$eval(e.directionLinks),b.boundaryLinks=!!angular.isDefined(e.boundaryLinks)&&b.$parent.$eval(e.boundaryLinks);var o=Math.max(b.maxSize,5);b.pages=[],b.pagination={last:1,current:1},b.range={lower:1,upper:1,total:1},b.$watch(function(){return(a.getCollectionLength(m)+1)*a.getItemsPerPage(m)},function(a){0<a&&h()}),b.$watch(function(){return a.getItemsPerPage(m)},function(a,c){a!=c&&"undefined"!=typeof c&&g(b.pagination.current)}),b.$watch(function(){return a.getCurrentPage(m)},function(a,b){a!=b&&g(a)}),b.setCurrent=function(b){k(b)&&(b=parseInt(b,10),a.setCurrentPage(m,b))}}function d(a,b,c,d){var f,g=[],h=Math.ceil(b/c),i=Math.ceil(d/2);f=a<=i?"start":h-i<a?"end":"middle";for(var j=d<h,k=1;k<=h&&k<=d;){var l=e(k,a,d,h),m=2===k&&("middle"===f||"end"===f),n=k===d-1&&("middle"===f||"start"===f);j&&(m||n)?g.push("..."):g.push(l),k++}return g}function e(a,b,c,d){var e=Math.ceil(c/2);return a===c?d:1===a?a:c<d?d-e<b?d-c+a:e<b?b-e+a:a:a}var f=/^\d+$/;return{restrict:"AE",templateUrl:function(a,c){return c.templateUrl||b.getPath()},scope:{maxSize:"=?",onPageChange:"&?",paginationId:"=?"},link:c}}function e(a){return function(b,c,d){if("undefined"==typeof d&&(d=j),!a.isRegistered(d))throw"pagination directive: the itemsPerPage id argument (id: "+d+") does not match a registered pagination-id.";var e,f;return b instanceof Array?(c=parseInt(c)||9999999999,f=a.isAsyncMode(d)?0:(a.getCurrentPage(d)-1)*c,e=f+c,a.setItemsPerPage(d,c),b.slice(f,e)):b}}function f(){var a,b={};this.registerInstance=function(c){"undefined"==typeof b[c]&&(b[c]={asyncMode:!1},a=c)},this.isRegistered=function(a){return"undefined"!=typeof b[a]},this.getLastInstanceId=function(){return a},this.setCurrentPageParser=function(a,c,d){b[a].currentPageParser=c,b[a].context=d},this.setCurrentPage=function(a,c){b[a].currentPageParser.assign(b[a].context,c)},this.getCurrentPage=function(a){var c=b[a].currentPageParser;return c?c(b[a].context):1},this.setItemsPerPage=function(a,c){b[a].itemsPerPage=c},this.getItemsPerPage=function(a){return b[a].itemsPerPage},this.setCollectionLength=function(a,c){b[a].collectionLength=c},this.getCollectionLength=function(a){return b[a].collectionLength},this.setAsyncModeTrue=function(a){b[a].asyncMode=!0},this.isAsyncMode=function(a){return b[a].asyncMode}}function g(){var a="angularUtils.directives.dirPagination.template";this.setPath=function(b){a=b},this.$get=function(){return{getPath:function(){return a}}}}var h,i="angularUtils.directives.dirPagination",j="__default";try{h=angular.module(i)}catch(k){h=angular.module(i,[])}h.directive("dirPaginate",["$compile","$parse","paginationService",a]).directive("dirPaginateNoCompile",b).directive("dirPaginationControls",["paginationService","paginationTemplate",d]).filter("itemsPerPage",["paginationService",e]).service("paginationService",f).provider("paginationTemplate",g).run(["$templateCache",c])}(),function(){"use strict";function a(a,b){function c(c,d){var e="grant_type=password&username="+c.username+"&password="+c.password;a.post(b.baseURL+"security/token",e,{headers:{"Content-Type":"application/x-www-form-urlencoded"}}).success(function(a){d(a)}).error(function(a){toastr.error(a.error_description,"Falha ao autenticar")})}var d={};return d.Login=c,d}angular.module("app").factory("AuthenticationService",a),a.$inject=["$http","CONSTANTS"]}(),function(){"use strict";function a(a,b){function c(c){return a.get(b.baseURL+"consumidor").then(c)}function d(c,d){return a.get(b.baseURL+"consumidor/"+c).then(d)}function e(c,d){return a.post(b.baseURL+"consumidor",c).then(d)}function f(c,d){return a.put(b.baseURL+"consumidor",c).then(d)}var g={};return g.GetAll=c,g.GetById=d,g.Create=e,g.Update=f,g}angular.module("app").factory("ConsumidorService",a),a.$inject=["$http","CONSTANTS"]}(),function(){"use strict";function a(a,b){function c(c){return a.get(b.baseURL+"user").then(c)}function d(c,d){return a.get(b.baseURL+"user/"+c).then(d)}function e(c,d){return a.post(b.baseURL+"user",c).then(d)}function f(c,d){return a.put(b.baseURL+"user",c).then(d)}var g={};return g.GetAll=c,g.GetById=d,g.Create=e,g.Update=f,g}angular.module("app").factory("UsuarioService",a),a.$inject=["$http","CONSTANTS"]}(),function(){"use strict";function a(a,b,c,d){function e(a){d.Update(a,function(a){toastr.success("Operação efetuada com sucesso.")})}function f(){b.path("/consumidores")}var g=this;g.save=e,g.cancel=f,d.GetById(parseInt(c.id),function(a){g.consumidor=a.data})}angular.module("app").controller("ConsumidorEditController",a),a.$inject=["$rootScope","$location","$routeParams","ConsumidorService"]}(),function(){"use strict";function a(a,b,c,d,e,f){function g(a){d.path("/consumidores/edit/"+a.UnidadeConsumidora)}function h(a){confirm("Tem certeza que deseja redefinir a senha do consumidor "+a.UnidadeConsumidora+"?")&&toastr.success("Operação efetuada com sucesso!")}function i(a){j.orderBy=a,j.reverse=!j.reverse}var j=this;j.edit=g,j.resetPassword=h,j.sort=i,j.orderBy="UnidadeConsumidora",j.reverse=!0,f.GetAll(function(a){j.consumidores=a.data})}angular.module("app").controller("ConsumidorListController",a),a.$inject=["$scope","$timeout","$rootScope","$location","$http","ConsumidorService"]}(),function(){"use strict";function a(a,b,c,d,e,f){function g(a){e.Login(a,function(a){i(l.user,a,h)})}function h(){b.path("/")}function i(b,e,g){a.isAuthenticated=!0,c.defaults.headers.common.Authorization="Bearer "+e.access_token,f.GetById(b.username,function(b){a.currentUser=b.data,a.theme=b.data.Theme,k(a.theme);var c={token:e.access_token,currentuser:b.data};d.put("_c",JSON.stringify(c)),g()})}function j(){a.isAuthenticated=!1,d.remove("_c"),a.currentUser={},a.theme="paper",k(a.theme),c.defaults.headers.common={Accept:"application/json, text/plain, */*"}}function k(b){switch(b){case"paper":a.themeColor="#2196F3";break;case"sandstone":a.themeColor="#93C54B";break;case"superhero":a.themeColor="#DF691A";break;case"yeti":a.themeColor="#008CBA"}}var l=this;l.login=g,function(){l.user={username:"",password:"",remember:!1},j()}()}angular.module("app").controller("AuthenticationController",a),a.$inject=["$rootScope","$location","$http","$cookies","AuthenticationService","UsuarioService"]}(),function(){"use strict";function a(a,b,c){}angular.module("app").controller("HomeController",a),a.$inject=["$rootScope","$location","UsuarioService"]}(),function(){"use strict";function a(a,b){}angular.module("app").controller("LogIntegracaoListController",a),a.$inject=["$rootScope","$location"]}(),function(){"use strict";function a(a,b,c,d,e,f){function g(a){f.Update(a,function(a){k.myUser&&h(a),toastr.success("Operação efetuada com sucesso.")})}function h(b){a.currentUser=b.data,a.theme=b.data.Theme,j(a.theme);var c=angular.fromJson(e.get("_c"));c.currentuser=b.data,e.remove("_c"),e.put("_c",JSON.stringify(c))}function i(){k.myUser?b.path("/"):b.path("/adm/usuarios")}function j(b){switch(b){case"paper":a.themeColor="#93C54B";break;case"sandstone":a.themeColor="#2196F3";break;case"superhero":a.themeColor="#DF691A";break;case"yeti":a.themeColor="#008CBA"}}var k=this;k.save=g,k.cancel=i,k.myUser=!1;var l="";!function(){"myUser"==d.current.$$route.param?(k.myUser=!0,l=a.currentUser.UserName):l=c.id}(),f.GetById(l,function(a){k.user=a.data})}angular.module("app").controller("UsuarioEditController",a),a.$inject=["$rootScope","$location","$routeParams","$route","$cookies","UsuarioService"]}(),function(){"use strict";function a(a,b,c){function d(a){b.path("/adm/usuarios/edit/"+a.UserName)}function e(a){f.orderBy=a,f.reverse=!f.reverse}var f=this;f.sort=e,f.edit=d,f.orderBy="Name",f.reverse=!0,c.GetAll(function(a){f.usuarios=a.data})}angular.module("app").controller("UsuarioListController",a),a.$inject=["$rootScope","$location","UsuarioService"]}();